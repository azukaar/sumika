...
// ListDevices enumerates and displays all available audio input devices
...
func NewVoiceRunner(config VoiceConfig, callbacks VoiceCallbacks) *VoiceRunner {
    return &VoiceRunner{
        config:    config,
        callbacks: callbacks,
...
func (vr *VoiceRunner) run() {
    ...
    processIntent := func(transcription string) *IntentResult {
                        ...
                        if intentResult != nil {
                            if intentResult.Intent != "" {
                                ...
                                if vr.callbacks.OnIntent != nil {
                                    vr.callbacks.OnIntent(event.Text, intentResult.Intent, intentResult.Command)
                                }
                            } else {
